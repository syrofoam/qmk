...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_BSLS, KC_SLSH, NO_BSLS, \
  KC_CAPSLOCK, _______, _______, _______, _______, _______, _______, _______, _______, KC_LBRACKET, KC_RBRACKET, KC_PSCREEN, \
  KC_RSHIFT, _______, _______, _______, _______, _______, _______, _______, KC_MPLY, KC_MSTP, NO_SLSH, KC_MENU, \
